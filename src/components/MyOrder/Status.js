...
export default function OrderStatus(props) {
  ...
  return (
    ...
    <div className={classes.root}>
      {role === "Contractor" && <Alert color={contractorTitle[status]} severity={contractorTitle[status]} variant="filled" >
         THIS ORDER IS {status.toUpperCase()}
      </Alert>}
      {role === "Client" && <Alert color={clientTitle[status]} severity={clientTitle[status]} variant="filled" >
